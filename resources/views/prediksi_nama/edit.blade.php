...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h1>Edit Prediksi Nama</h1>
                <form method="POST" action="{{ route('prediksi-nama.update', $prediksi_nama->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama</label>
                        <input type="text" class="form-control" id="nama" name="nama" required value="{{ $prediksi_nama->nama }}">
                    </div>
                    <div class="mb-3">
                        <label for="negara_1" class="form-label">Negara 1</label>
                        <input type="text" class="form-control" id="negara_1" name="negara_1" value="{{ $prediksi_nama->negara_1 }}">
                    </div>
                    <div class="mb-3">
                        <label for="negara_2" class="form-label">Negara 2</label>
                        <input type="text" class="form-control" id="negara_2" name="negara_2" value="{{ $prediksi_nama->negara_2 }}">
                    </div>
                    <div class="mb-3">
                        <label for="negara_3" class="form-label">Negara 3</label>
                        <input type="text" class="form-control" id="negara_3" name="negara_3" value="{{ $prediksi_nama->negara_3 }}">
                    </div>
                    <div class="mb-3">
                        <label for="negara_4" class="form-label">Negara 4</label>
                        <input type="text" class="form-control" id="negara_4" name="negara_4" value="{{ $prediksi_nama->negara_4 }}">
                    </div>
